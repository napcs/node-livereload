...
(function() {
  ...
  Server = (function() {
    function Server(config1) {
      ...
      if ((base3 = this.config).observeOnlyExts == null) {
        base3.observeOnlyExts = [];
      }
      if ((base4 = this.config).exclusions == null) {
        base4.exclusions = [];
      }
      this.config.exts = this.config.observeOnlyExts.length > 0 ? this.config.observeOnlyExts : this.config.exts.concat(defaultExts);
