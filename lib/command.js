...
(function() {
  ...
  runner = function() {
    var debug, exclusions, exts, livereload, observeOnlyExts, opts, path, pjson, port, resolve, server, usePolling, version, wait;
    ...
    observeOnlyExts = opts.get('observeonly') ? opts.get('observeonly').split(',') : [];
