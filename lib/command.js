...
(function() {
  ...
  runner = function() {
    var args, corp, cors, debug, exclusions, extraExts, exts, filesToReload, host, livereload, options, opts, originalPath, path, pjson, port, resolve, server, usePolling, version, wait;
